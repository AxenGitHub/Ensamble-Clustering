...
system.time(consMatrixAlg <-DatasetAnalysis(as.matrix(rock), datasetName = "Rock"))
...
system.time(consMatrixAlg<-ConsensusMatrixAnalysis(sphere=TRUE, datasetName = "Rock", chgCl=TRUE))
